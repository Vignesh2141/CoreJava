package com.task;
import java.io.*;
public class FileCreationStream {
	 ...
	 { 
	 byte input[] = getInput(); 
	 OutputStream f = new FileOutputStream("C:\\Users\\user\\eclipse-training\\Tasks\\src\\com\\task\\write.txt"); 
	 for(int i=0; i<50; i++) 
	 { 
	 f.write(input [i]); 
	 } 
	 f.close(); 
	 int size; 
	 InputStream f1 = new FileInputStream ("C:\\Users\\user\\eclipse-training\\Tasks\\src\\com\\task\\write.txt"); 
	 size = f1.available(); 
